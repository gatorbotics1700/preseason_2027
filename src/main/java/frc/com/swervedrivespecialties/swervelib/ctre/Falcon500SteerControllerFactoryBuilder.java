...
public final class Falcon500SteerControllerFactoryBuilder {
  ...
  private class FactoryImplementation<T>
    ...
    public ControllerImplementation create(
      ...
      // motorConfiguration.Feedback.SensorToMechanismRatio = -1; // TODO: make this
      ...
      checkCtreError(
          motor.getConfigurator().apply(motorConfiguration, CAN_TIMEOUT_SEC),
      ...
      checkCtreError(
          motor.setPosition(
              absoluteEncoder.getAbsoluteAngle() / sensorPositionCoefficient, CAN_TIMEOUT_SEC),
  ...
  private static class ControllerImplementation implements SteerController {
    ...
    public void setReferenceAngle(double referenceAngleRadians) {
      double currentAngleRadians =
          motor.getPosition().getValueAsDouble() * motorEncoderPositionCoefficient;
      ...
      // anymore.
      if (motor.getVelocity().getValueAsDouble() * motorEncoderVelocityCoefficient
