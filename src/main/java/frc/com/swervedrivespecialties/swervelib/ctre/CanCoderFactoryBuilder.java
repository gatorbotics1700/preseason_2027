  ...
  public AbsoluteEncoderFactory<CanCoderAbsoluteConfiguration> build() {
    return configuration -> {
      ...
      CtreUtils.checkCtreError(
          encoder.getConfigurator().apply(config, buildTimeoutSeconds),
          "Failed to configure CANCoder");

      CtreUtils.checkCtreError(
          encoder.getPosition().setUpdateFrequency(150, 0.25),
          "Failed to configure CANCoder update rate"); // was 1000.0 / periodMilliseconds
