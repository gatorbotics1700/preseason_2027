...
public class ShotCalculator {
  ...
  public static ShotParameters calculateShot(
    ...
    Translation2d botToShooter = new Translation2d(Constants.BOT_RELATIVE_SHOOTER_POSE.getX(), Constants.BOT_RELATIVE_SHOOTER_POSE.getY());
    ...
    Rotation2d fieldRelativeTurretAngle = new Rotation2d(Math.atan2(deltaY, deltaX)); // TODO add real math for this :)
    Rotation2d turretAngle =
        fieldRelativeTurretAngle.minus(drivetrainPose.getRotation()); // TODO check the math on this


    //calculate hood angle
    Pose3d shooterPose3d = new Pose3d(shooterPose.getX(), shooterPose.getY(), Constants.BOT_RELATIVE_SHOOTER_POSE.getZ(), new Rotation3d(0,0, turretAngle.getRadians()));
