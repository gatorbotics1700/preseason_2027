...
public class TrajectoryCommand extends Command{
    ...
    public TrajectoryCommand(Pose2d[] poses, Drive drive){
        ...
        controller = new HolonomicDriveController( // all the PIDs need tuning
            new PIDController(kPx, kIx, kDx),
            new PIDController(kPy, kIy, kDy),
            new ProfiledPIDController(kPr, kIr, kDr, 
        ...
        config = new TrajectoryConfig( // these values need tuning
    ...
    public void execute(){
        ...
        ChassisSpeeds adjustedSpeeds = controller.calculate(
            drive.getPose(), desiredPose, desiredHeading);
